(function () {
  ...
  const iconPaths = {
    ...
    afdian: '<path d="M12 20.5s-7-4.4-8.7-9.1C2.1 8 4.3 5 7.3 5c1.7 0 3.1.9 4.7 3 1.6-2.1 3-3 4.7-3 3 0 5.2 3 4 6.4C19 16.1 12 20.5 12 20.5z"/><path d="M9.5 12h5M12 9.5v5"/>',
  };
